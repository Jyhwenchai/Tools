...
class EncryptionService {
  ...
  func encrypt(_ text: String, using algorithm: EncryptionAlgorithm, key: String? = nil) throws -> String {
  ...
  func decrypt(_ text: String, using algorithm: EncryptionAlgorithm, key: String? = nil) throws -> String {
    guard !text.isEmpty else {
      throw ToolError.invalidInput("输入文本不能为空")
    }
