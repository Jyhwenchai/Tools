...
struct ImageCropView: View {
                    ...
                    Rectangle()
                        ...
                        .overlay(
                            Rectangle()
                                ...
                                .offset(
                                    x: (cropRect.origin.x * imageDisplaySize.width / image.size.width) - imageDisplaySize.width / 2,
                                    y: (cropRect.origin.y * imageDisplaySize.height / image.size.height) - imageDisplaySize.height / 2
                                )
    ...
    private func cropHandle(at index: Int) -> some View {
        ...
        let positions = [
            ...
            CGPoint(x: cropDisplayRect.origin.x + cropDisplayRect.size.width, y: cropDisplayRect.origin.y), // Top-right
            CGPoint(x: cropDisplayRect.origin.x, y: cropDisplayRect.origin.y + cropDisplayRect.size.height), // Bottom-left
            CGPoint(x: cropDisplayRect.origin.x + cropDisplayRect.size.width, y: cropDisplayRect.origin.y + cropDisplayRect.size.height)  // Bottom-right
        ]
