...
struct EnhancedDropZone: View {
  ...
  enum DragFeedback {
    ...
    var message: String {
      switch self {
      case .none: return ""
      case .valid: return "✓ 释放以添加文件"
      case .invalid: return "⚠️ 不支持的文件格式"
      case .tooLarge: return "❌ 文件过大"
      case .hovering: return "📁 检查文件格式中..."
      }
    }
    
    var icon: String {
      switch self {
      case .none: return "doc.badge.plus"
      case .valid: return "checkmark.circle.fill"
      case .invalid: return "exclamationmark.triangle.fill"
      case .tooLarge: return "exclamationmark.octagon.fill"
      case .hovering: return "magnifyingglass"
      }
    }
  }
