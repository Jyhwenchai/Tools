...
class AppSettings {
  ...
  @ObservationIgnored @AppStorage("app_theme") private var themeRawValue: String = AppTheme.system
    .rawValue
  var theme: AppTheme {
  ...
  // Clipboard settings
  @ObservationIgnored @AppStorage("max_clipboard_history") private var _maxClipboardHistory: Int =
    100
  ...
  @ObservationIgnored @AppStorage(
    "confirm_destructive_actions") private var _confirmDestructiveActions: Bool =
    true
  ...
  // UI settings
  @ObservationIgnored @AppStorage(
    "show_processing_animations") private var _showProcessingAnimations: Bool =
    true
  ...
  @ObservationIgnored @AppStorage(
    "default_image_quality") private var _defaultImageQuality: Double =
    0.8
