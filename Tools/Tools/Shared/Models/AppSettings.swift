...
class AppSettings: ObservableObject {
  ...
  // Clipboard settings
  @AppStorage("max_clipboard_history") private var _maxClipboardHistory: Int = 100
  ...
  // Behavior settings
  @AppStorage("auto_save_results") private var _autoSaveResults: Bool = true
  var autoSaveResults: Bool {
    get { _autoSaveResults }
    set { _autoSaveResults = newValue }
  }

  @AppStorage("auto_copy_results") private var _autoCopyResults: Bool = false
  var autoCopyResults: Bool {
    get { _autoCopyResults }
    set { _autoCopyResults = newValue }
  }

  @AppStorage("confirm_destructive_actions") private var _confirmDestructiveActions: Bool = true
  ...
  // UI settings
  @AppStorage("show_processing_animations") private var _showProcessingAnimations: Bool = true
  ...
  @AppStorage("default_image_quality") private var _defaultImageQuality: Double = 0.8
