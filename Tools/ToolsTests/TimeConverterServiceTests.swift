...
final class TimeConverterServiceTests: XCTestCase {
    ...
    func testTimestampToISO8601Conversion() {
        ...
        XCTAssertEqual(result.timestamp, 1640995200)
    }
    ...
    func testTimeZoneConversion() {
        ...
        let result = service.convertTime(input: "1640995200", options: options) // 2022-01-01 00:00:00 UTC
    ...
    func testTimeZoneConversionMethod() {
        let utcDate = Date(timeIntervalSince1970: 1640995200) // 2022-01-01 00:00:00 UTC
        let utcTimeZone = TimeZone(identifier: "UTC")!
        ...
        let expectedTimestamp = 1640995200 + (9 * 3600)
        XCTAssertEqual(convertedDate.timeIntervalSince1970, TimeInterval(expectedTimestamp), accuracy: 1.0)
    }
    ...
    func testDateStringValidation() {
        ...
        XCTAssertTrue(service.validateDateString("2022-01-01 00:00:00", format: .custom, customFormat: "yyyy-MM-dd HH:mm:ss"))
        
        XCTAssertFalse(service.validateDateString("invalid date", format: .iso8601))
        XCTAssertFalse(service.validateDateString("2022-13-01T00:00:00Z", format: .iso8601)) // Invalid month
    ...
    func testCalculateTimeDifference() {
        let startDate = Date(timeIntervalSince1970: 1640995200) // 2022-01-01 00:00:00
        let endDate = Date(timeIntervalSince1970: 1641081600)   // 2022-01-02 00:00:00
