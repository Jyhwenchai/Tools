...
struct CoreFunctionalityIntegrityTests {
  ...
  @Test("验证应用启动无权限弹窗")
  func testApplicationStartupWithoutPermissionPrompts() async {
    // 验证应用主要组件可以正常初始化
  ...
  @Test("验证导航管理器无权限依赖")
  func testNavigationManagerWithoutPermissions() {
  ...
  @Test("验证文件对话框工具无需权限")
  func testFileDialogUtilsWithoutPermissions() {
  ...
  @Test("验证拖拽导入功能支持")
  func testDragDropFunctionalitySupport() {
    // 验证拖拽相关的UTType支持
  ...
  @Test("验证加密工具核心功能")
  func testEncryptionToolCoreFunctionality() {
  ...
  @Test("验证JSON工具核心功能")
  func testJSONToolCoreFunctionality() {
  ...
  @Test("验证图片处理工具核心功能")
  func testImageProcessingToolCoreFunctionality() {
  ...
  @Test("验证二维码工具核心功能")
  func testQRCodeToolCoreFunctionality() async {
  ...
  @Test("验证时间转换工具核心功能")
  func testTimeConverterToolCoreFunctionality() {
  ...
  @Test("验证粘贴板工具权限优化")
  func testClipboardToolPermissionOptimization() {
    // 验证粘贴板项目模型
  ...
  @Test("验证应用设置无权限依赖")
  func testAppSettingsWithoutPermissionDependencies() {
    let settings = AppSettings.shared
    
    // 验证默认设置可以正常访问
    #expect(settings.theme == AppTheme.system || settings.theme == AppTheme.light || settings.theme == AppTheme.dark)
  ...
  func testErrorHandlingWithoutPermissionErrors() {
  ...
  @Test("验证性能监控权限移除")
  func testPerformanceMonitoringPermissionRemoval() {
    let performanceMonitor = PerformanceMonitor.shared
  ...
  @Test("验证安全服务权限简化")
  func testSecurityServicePermissionSimplification() {
    let securityService = SecurityService.shared
  ...
  @Test("验证异步操作管理无权限依赖")
  func testAsyncOperationManagerWithoutPermissions() {
  ...
  @Test("验证共享UI组件无权限依赖")
  func testSharedUIComponentsWithoutPermissions() {
  ...
  @Test("验证端到端工作流无权限阻塞")
  func testEndToEndWorkflowWithoutPermissionBlocking() async {
  ...
  @Test("验证应用权限配置已最小化")
  func testApplicationEntitlementsMinimized() {
    // 验证应用bundle存在
