...
struct FileOperationUserExperienceTests {
  ...
  func enhancedDropZoneVisualFeedback() async {
  ...
  func enhancedDropZoneFileTypes() async {
  ...
  func enhancedDropZoneFileSizeLimits() async {
    let dropZone = EnhancedDropZone.forImages(
      onFilesDropped: { _ in },
      onButtonTapped: {})
  ...
  func fileOperationGuideTips() async {
  ...
  func fileOperationGuideMetadata() async {
    let guides = [
  ...
  func fileDialogUtilsFileTypeValidation() async {
    // Create test URLs
  ...
  func fileValidationResult() async {
    // Create test URLs
    ...
    #expect(result.oversizedFiles.isEmpty)
  ...
  func contextualFileOperationHelp() async {
  ...
  func userFriendlyErrorMessages() async {
    let supportedTypes: [UTType] = [.png, .jpeg]
  ...
  func fileOperationAccessibility() async {
  ...
  func fileOperationPerformance() async {
    ...
    let startTime = Date()
    let result = FileDialogUtils.validateFiles(
      urls,
      supportedTypes: supportedTypes,
      maxFileSize: maxFileSize)
    let endTime = Date()
  ...
  func fileOperationIntegration() async {
  ...
  func fileOperationLocalization() async {
    let dragDropGuide = FileOperationGuide.OperationType.dragDrop
