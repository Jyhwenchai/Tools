...
struct TimeConverterModelsTests {
  ...
  func testTimeFormatCompleteness() {
  ...
  func testTimeConversionResultSuccess() {
    let timestamp: TimeInterval = 1640995200 // 2022-01-01 00:00:00 UTC
  ...
  func testTimeConversionResultFailure() {
  ...
  func testTimeConversionResultSuccessResultOnly() {
  ...
  func testTimeZoneInfoBasicProperties() {
  ...
  func testTimeZoneInfoDifferentTimeZones(
    identifier: String,
  ...
  func testTimeZoneInfoOffsetStringFormat(offset: Int, expectedOffsetString: String) {
  ...
  func testTimeZoneInfoIdentifiable() {
  ...
  func testTimeConversionOptionsDefaultInitialization() {
  ...
  func testTimeConversionOptionsCustomInitialization() {
  ...
  @Test("常用时区唯一性测试")
  func testCommonTimeZonesUniqueness() {
    let commonTimeZones = TimeZoneInfo.commonTimeZones
