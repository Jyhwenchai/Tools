...
struct QRCodeModelsTests {
  ...
  func qRCodeCorrectionLevelValues(
  ...
  func qRCodeCorrectionLevelCompleteness() {
  ...
  func qRCodeCorrectionLevelCodable() throws {
  ...
  func qRCodeOptionsDefaultInitialization() {
  ...
  func qRCodeOptionsCustomInitialization() {
  ...
  func qRCodeOptionsCodable() throws {
    let options = QRCodeOptions(
  ...
  func qRCodeGenerationResultProperties() {
  ...
  func qRCodeGenerationResultTimestamp() {
  ...
  func qRCodeRecognitionResultBasicInitialization() {
    let text = "识别的文本"
  ...
  func qRCodeRecognitionResultFullInitialization() {
    let text = "完整识别文本"
  ...
  func qRCodeRecognitionResultTimestamp() {
    let beforeCreation = Date()
  ...
  func qRCodeRecognitionResultEdgeCases() {
    // 空文本测试
  ...
  func colorCodableBasicColors(color: Color) throws {
    let encoder = JSONEncoder()
  ...
  func colorCodableCustomColor() throws {
