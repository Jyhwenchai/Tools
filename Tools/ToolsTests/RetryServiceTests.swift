...
struct RetryServiceTests {
  ...
  func aggressiveRetryConfiguration() {
  ...
  func conservativeRetryConfiguration() {
  ...
  @Test("成功操作无需重试测试")
  func successfulOperationNoRetry() async throws {
  ...
  @Test("失败操作重试测试")
  func failedOperationRetry() async throws {
    let service = RetryService.shared
    var attemptCount = 0
  ...
  @Test("所有重试失败测试")
  func allRetriesFailed() async throws {
    let service = RetryService.shared
    var attemptCount = 0
  ...
  @Test("条件重试测试")
  func conditionalRetry() async throws {
    let service = RetryService.shared
    var attemptCount = 0
  ...
  @Test("条件重试不满足条件测试")
  func conditionalRetryNotMet() async throws {
    let service = RetryService.shared
    var attemptCount = 0
  ...
  @Test("工具操作重试测试")
  func toolOperationRetry() async throws {
    let service = RetryService.shared
    var attemptCount = 0
  ...
  @Test("网络操作重试测试")
  func networkOperationRetry() async throws {
    let service = RetryService.shared
    var attemptCount = 0
  ...
  @Test("文件操作重试测试")
  func fileOperationRetry() async throws {
    let service = RetryService.shared
    var attemptCount = 0
  ...
  @Test("延迟计算测试")
  func delayCalculation() async throws {
    let service = RetryService.shared
