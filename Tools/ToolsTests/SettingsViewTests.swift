...
struct SettingsViewTests {
  ...
  func importExportSettingsViewInitialization() {
  ...
  @Test("设置视图状态管理测试")
  func settingsViewStateManagement() {
    // 使用共享设置实例
