...
struct SharedComponentsTests {
  ...
  func toolButtonStyles(style: ToolButton.ButtonStyle, title: String) {
  ...
  func toolButtonStyleCompleteness() {
  ...
  func processingStateView(isProcessing: Bool, message: String) {
  ...
  func toolResultViewCopyFeature(canCopy: Bool, content: String) {
