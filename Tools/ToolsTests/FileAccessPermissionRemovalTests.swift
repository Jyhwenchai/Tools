...
struct FileAccessPermissionRemovalTests {
  ...
  func testSecurityServiceNoFileAccessPermission() async {
  ...
  func testToolErrorNoPermissionDenied() {
  ...
  func testFileDialogUtilsAvailable() {
  ...
  @Test("验证应用权限配置已简化")
  func testEntitlementsSimplified() {
  ...
  @Test("验证文件操作使用系统对话框")
  func testFileOperationsUseSystemDialogs() {
  ...
  func testFileOperationsWithoutFolderPermissions() {
  ...
  func testEntitlementsFileAccessRemoved() {
