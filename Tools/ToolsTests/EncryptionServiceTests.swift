...
struct EncryptionServiceTests {
  ...
  @Test("MD5 空输入测试")
  func testMD5EmptyInput() async throws {
    let service = EncryptionService.shared
  ...
  @Test("SHA1 哈希算法测试")
  func testSHA1Hashing() async throws {
    let service = EncryptionService.shared
  ...
  @Test("SHA1 结果长度测试")
  func testSHA1Length() async throws {
    let service = EncryptionService.shared
  ...
  @Test("SHA256 哈希算法测试")
  func testSHA256Hashing() async throws {
    let service = EncryptionService.shared
  ...
  @Test("SHA256 结果长度测试")
  func testSHA256Length() async throws {
    let service = EncryptionService.shared
  ...
  func testBase64InvalidDecoding() async throws {
    let service = EncryptionService.shared
  ...
  @Test("AES 加密解密测试")
  func testAESEncryptionDecryption() async throws {
    let service = EncryptionService.shared
  ...
  @Test("AES 不同密钥测试")
  func testAESDifferentKeys() async throws {
    let service = EncryptionService.shared
  ...
  @Test("AES 空密钥测试")
  func testAESEmptyKey() async throws {
    let service = EncryptionService.shared
    let plaintext = "Test"
  ...
  @Test("AES 长文本测试")
  func testAESLongText() async throws {
    let service = EncryptionService.shared
  ...
  @Test("AES 特殊字符测试")
  func testAESSpecialCharacters() async throws {
    let service = EncryptionService.shared
  ...
  @Test("哈希算法不支持解密测试")
  func testHashAlgorithmsNoDecryption() async throws {
    let service = EncryptionService.shared
  ...
  @Test("算法支持解密属性测试")
  func testAlgorithmDecryptionSupport() {
  ...
  func testLargeFileEncryptionPerformance() async throws {
    let service = EncryptionService.shared
