...
struct JSONServiceTests {
  ...
  @Test("JSON格式化 - 嵌套对象测试")
  func jSONFormattingWithNestedObjects() throws {
    let service = JSONService.shared
  ...
  @Test("JSON格式化 - 数组测试")
  func jSONFormattingWithArrays() throws {
    let service = JSONService.shared
  ...
  @Test("JSON格式化 - 空字符串错误")
  func jSONFormattingEmptyString() {
    let service = JSONService.shared
  ...
  func jSONFormattingInvalidJSON() {
    let service = JSONService.shared
  ...
  @Test("JSON压缩 - 复杂结构测试")
  func jSONMinificationComplexStructure() throws {
    let service = JSONService.shared
    let input = """
    {
      "users": [
  ...
  @Test("JSON压缩 - 空字符串错误")
  func jSONMinificationEmptyString() {
    let service = JSONService.shared
  ...
  func jSONMinificationInvalidJSON() {
    let service = JSONService.shared
    let invalidJSON = #"{"name": "John", "age":}"#
  ...
  func jSONValidationValid(json: String) {
    let service = JSONService.shared
  ...
  func jSONValidationInvalid(json: String) {
    let service = JSONService.shared
    let result = service.validateJSON(json)
  ...
  @Test("JSON验证 - 空字符串测试")
  func jSONValidationEmptyString() {
    let service = JSONService.shared
  ...
  @Test("Swift代码生成测试")
  func swiftCodeGeneration() throws {
    let service = JSONService.shared
  ...
  @Test("Java代码生成测试")
  func javaCodeGeneration() throws {
    let service = JSONService.shared
    let json = #"{"name":"John","age":30,"isActive":true}"#
  ...
  @Test("Python代码生成测试")
  func pythonCodeGeneration() throws {
    let service = JSONService.shared
    let json = #"{"name":"John","age":30,"isActive":true}"#
  ...
  func typeScriptCodeGeneration() throws {
    let service = JSONService.shared
    let json = #"{"name":"John","age":30,"isActive":true}"#
  ...
  @Test("代码生成 - 复杂对象测试")
  func codeGenerationComplexObject() throws {
    let service = JSONService.shared
    let json = """
    {
      "user": {
  ...
  @Test("代码生成 - 空字符串错误")
  func codeGenerationEmptyString() {
    let service = JSONService.shared
  ...
  @Test("代码生成 - 无效JSON错误")
  func codeGenerationInvalidJSON() {
    let service = JSONService.shared
    let invalidJSON = #"{"name": "John", "age":}"#
  ...
  @Test("代码生成 - 非对象JSON错误")
  func codeGenerationNonObjectJSON() {
    let service = JSONService.shared
    let arrayJSON = "[1, 2, 3]"
  ...
  @Test("处理特殊字符的JSON")
  func jSONWithSpecialCharacters() throws {
    let service = JSONService.shared
  ...
  @Test("处理大数字的JSON")
  func jSONWithLargeNumbers() throws {
    let service = JSONService.shared
