...
struct AsyncOperationManagerTests {
  ...
  func asyncOperationBasicProperties() {
  ...
  func asyncOperationCancellation() {
  ...
  @Test("简单异步操作执行测试")
  func simpleAsyncOperationExecution() async throws {
  ...
  @Test("异步操作错误处理测试")
  func asyncOperationErrorHandling() async throws {
    let manager = AsyncOperationManager.shared
    let expectation = AsyncExpectation()
  ...
  @Test("带进度的异步操作测试")
  func asyncOperationWithProgress() async throws {
    let manager = AsyncOperationManager.shared
    let expectation = AsyncExpectation()
  ...
  @Test("重试机制测试")
  func retryMechanism() async throws {
    let manager = AsyncOperationManager.shared
    let expectation = AsyncExpectation()
    var attemptCount = 0
  ...
  @Test("操作管理功能测试")
  func operationManagement() async throws {
    let manager = AsyncOperationManager.shared
