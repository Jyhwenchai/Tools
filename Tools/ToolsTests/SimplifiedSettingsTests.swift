...
struct SimplifiedSettingsTests {
  ...
  func settingsInterfaceSimplification() {
  ...
  func settingsPersistence() {
    ...
    #expect(
      settings.maxClipboardHistory == newHistory,
      "Clipboard history should change immediately")
  ...
  func settingsSimplificationBenefits() {
    let settings = AppSettings.shared
